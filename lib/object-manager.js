 ...
 */
var manage = function (obj, path, depth, callback, upsert) {
    var err = null, i, key;
...
ptp.find = function (query, callback) {
    ...
    var path = query && query.split(this.delim) || [],
        result = manage(this.ctx, path, path.length, callback);
...
ptp.update = function (query, value, callback, upsert) {
    ...
    var path = query && query.split(this.delim) || [],
        ...
        ctx = this.ctx,
        result = callback || manage(ctx, path, depth, callback, upsert),
    ...
    if(callback) {
        manage(ctx, path, depth, function (err, obj) {
